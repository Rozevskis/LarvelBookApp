<x-app-layout>
    <div class="container mx-auto p-6">
        <div class="max-w-lg mx-auto bg-white p-8 rounded shadow">
            <h2 class="text-2xl font-bold mb-6">Create New Book</h2>
            <form action="{{ route('book.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="released_at" name="released_at" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>
